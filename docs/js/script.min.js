...
!function (e) {
    ...
    _initListview(e) {
      ...
      if (t && t.matches(".mm-listitem") && !_(t, ".mm-btn").length) {
        ...
        if (n) {
          ...
          i.setAttribute("href", "#" + e.id), n.matches("span") ? (i.classList.add("mm-listitem__text"), i.innerHTML = n.innerHTML, t.insertBefore(i, n.nextElementSibling), n.remove()) : t.append(i);
        }
      }
  ...
  S.version = "8.2.2", S.options = i, S.configs = s, S.addons = {}, S.wrappers = {}, S.node = {}, S.vars = {};
  var M = {
    blockUI: !0,
    moveBackground: !0
  };
